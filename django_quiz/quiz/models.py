...
class Progress(models.Model):
    ...
    score = models.TextField(max_length=1024, verbose_name=_("Score"))
    ...
    def list_all_cat_scores(self):
        ...
        for cat in Category.objects.all():
            ...
            if match:
                score = self.sitting.staika_score
    ...
    def update_score(self, question, guess):
        """
    ...
    def update(self, question, score_to_add):
...
class Sitting(models.Model):
    ...
    statika_score = models.IntegerField(default=0, verbose_name=_("Statica Score"))

    racionalnost_score = models.IntegerField(default=0, verbose_name=_("Racionalnost Score"))

    strategy_score = models.IntegerField(default=0, verbose_name=_("Strategy Score"))

    emotivizm_score = models.IntegerField(default=0, verbose_name=_("Emotivizm Score"))
    ...
    def add_to_racionalnost(self, points):
        self.racionalnost_score += int(points)
        self.save()

    def add_to_strategy(self, points):
        self.strategy_score += int(points)
        self.save()

    def add_to_statika(self, points):
        self.statika_score += int(points)
        self.save()

    def add_to_emotivizm(self, points):
        self.emotivizm_score += int(points)
        self.save()
